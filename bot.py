...
OWNER      = "@x07_wy"
OWNER_ID   = int(os.environ.get("OWNER_ID", "8785789269"))  
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 🎲 ألعاب كت / لو خيروك / جرأة أو صراحة
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

KAT_QUESTIONS = [
    "وسّمها مدامتك لقديمة",
    "هل مرّ في حياتك شخص كنت تعتبره محل ثقة، ثم اكتشفت أنه محل أحذية؟",
    "هل سبق وأعطيت شخصاً أكبر من حجمه ثم ندمت؟",
    "اسم آخر شخص زعلك؟",
    "أكثر علاقة أتعبتك من غير ما تستاهل؟",
    "في أي لحظة قررت إنك ما راح تكرر نفس الغلطة مرة ثانية؟",
    "هل عندك شخص لو رجع لحياتك ما كنت تقبله؟ ليش؟",
    "أكثر شيء ندمت إنك قلته لشخص؟",
    "هل سبق وسامحت شخص على شيء ما تسامح عليه الناس عادةً؟",
    "أقرب ناس لك — هل تعتقد إنهم يعرفونك فعلاً؟",
    "هل عندك شخص تحبه بصمت من زمان وما قلت له؟",
    "أكثر شخص تمنيت يفهمك ولم يفعل؟",
    "علاقة انتهت وما زلت تفكر فيها — ما القصة؟",
    "هل سبق وعذرت شخصاً على شيء ما يستحق العذر؟",
    "آخر مرة بكيت بسبب شخص — من كان؟",
    "شخص كنت تحسبه صديق وظهر وقت الضيق على حقيقته؟",
    "هل عندك حسرة على علاقة انتهت بسبب غلطتك أنت؟",
    "أكثر شيء أفقدك ثقتك بشخص قريب منك؟",
    "هل سبق اتصلت بشخص وأنت تبكي وأنت تعرف إنه ما راح يفيد؟",
    "أكثر شخص أثّر في شخصيتك — للأفضل أو للأسوأ؟",
    "أفضل صفة تحبها في نفسك؟",
    "أكثر عيب تعترف فيه على نفسك ولو بصعوبة؟",
    "شيء تخجل منه في نفسك ولا تقوله لأحد؟",
    "آخر كذبة قلتها وأنت مرتاح لها؟",
    "هل تحسد أحد من معارفك؟ على إيش؟",
    "أكثر موقف تصرفت فيه بأنانية وعارف ذلك؟",
    "شيء تتمنى يتغير في نفسك بس خايف تعترف إنه موجود؟",
    "هل سبق خذلت نفسك في موقف كنت تتوقع منها أكثر؟",
    "أكثر شيء يغيظك في الناس وأنت تعرف إنه موجود فيك كذلك؟",
    "هل أنت الشخص اللي تبي تكونه؟ ولا لسا؟",
    "شيء تقوله للناس إنه ما يهمك وهو في الحقيقة يهمك جداً؟",
    "آخر مرة تصنّعت قدام ناس تهتم لرأيهم؟",
    "أكثر قرار خوّفك من نفسك بعد ما اتخذته؟",
    "هل سبق حسست إنك تستاهل أكثر مما عندك — بصدق؟",
    "شيء تعمله تعبّر فيه عن نفسك وما يعرفه أحد؟",
    "أكثر لحظة أحسست فيها إنك إنسان غلط في مكان غلط؟",
    "هل عندك عادة سلبية تعرفها وما عندك نية تتوقف عنها؟",
    "آخر مرة حسيت إنك ناقص شيء ما تعرف وش هو؟",
    "شيء تتمنى يعرفه الناس عنك بدون ما تضطر تقوله؟",
    "هل أنت راضٍ عن نفسك — الآن، هذه اللحظة؟",
    "رسالة تودّ إيصالها لشخص رحل من حياتك؟",
    "رسالتك للسنوات المقبلة؟",
    "ما هو الموقف الذي غيّر طريقة تفكيرك للأبد؟",
    "لو كان بإمكانك تمحي ذكرى واحدة — إيش تختار؟",
    "شيء تتمنى لو تعلّمته أبكر في حياتك؟",
    "لو تكلّمت مع نفسك قبل ١٠ سنوات — إيش كنت تقول لها؟",
    "أكثر سؤال يدور في بالك ولا تجد له جواب؟",
    "ما هو الشيء اللي تخاف تعترف حتى لنفسك إنك تريده؟",
    "لحظة أحسست فيها إن الحياة تستحق فعلاً — إيش كانت؟",
    "لو عرفت إن عندك سنة بس — إيش أول شيء تغيّره؟",
    "هل تؤمن إن كل شخص يمر في حياتك له سبب؟",
    "أكثر درس علّمتك إياه خسارة؟",
    "ما هو الشيء اللي تحسب الناس ما تفهمه فيك؟",
    "ما هو الموقف اللي شاهدته مرة ولم تنساه؟",
    "هل عندك حلم تخلّيت عنه وما زلت تفكر فيه؟",
    "لو تكتب جملة واحدة تلخص حياتك لحد الآن — إيش هي؟",
    "أكثر شيء خسرته وعرفت قيمته بعد ما راح؟",
    "هل تؤمن إنك تستحق السعادة — فعلاً وبصدق؟",
    "ما هو القرار اللي تمنيت لو أخذته بدون تفكير؟",
    "ما الذي تعلّمته عن نفسك في أصعب فترة مررت بها؟",
    "هل تملك في حياتك شخص حين تشعر بالضيق تحادثه؟ ومن هو؟",
    "هل سبق وأخطأت بحق شخص ولم تعتذر له حتى الآن؟",
    "من هو الشخص الذي تتمنى لو قال لك 'أنا فخور فيك'؟",
    "آخر شخص فكرت فيه قبل النوم — من هو؟",
    "هل عندك شخص تشعر معه إنك لا تحتاج تتصنّع؟",
    "شيء تتمنى لو أحد يسألك عنه ولا أحد يسأل؟",
    "هل سبق حسيت إنك وحيد وسط ناس كثير؟",
    "من هو الشخص اللي لو اتصل فيك الآن تفرح؟",
    "هل تعتقد إن أقرب الناس لك يعرفون وش يحصل معك فعلاً؟",
    "أكثر شخص منّيت نفسك يطمّن عليك ولم يفعل؟",
    "هل أنت الشخص اللي يبدأ أم اللي ينتظر؟",
    "من هو الشخص اللي لو اعتذر لك الآن راح تسامحه؟",
    "هل سبق وسهرت الليل بسبب كلام شخص كان يفترض ما يأثر فيك؟",
    "شخص قلته 'اشتقت لك' بقلبك ولم تقلها بلسانك؟",
    "هل عندك نص رسالة مكتوب ولم ترسله لأحد؟",
    "آخر مرة طلبت مساعدة من أحد وهو رفض؟",
    "من هو الشخص اللي تحسبه دايم موجود — وتخاف يوم ما يكون؟",
    "هل تقدر تقول 'أنا بخير' وأنت فعلاً تقصد؟",
    "شيء تبي تقوله لشخص معين بس تعرف إنه ما يفهمه؟",
    "هل سبق وحسيت إن أحد يحبك أكثر مما تستاهل؟",
    "هل أنت الشخص اللي يُترك أم اللي يترك؟",
    "أكثر شيء خسّرك ثقتك بنفسك؟",
    "هل سبق قلت 'بخير' وأنت تتمنى أحد يكذّبك؟",
    "من هو الشخص اللي تعتقد إنه يفكر فيك الآن؟",
    "هل تعتقد إنك شخص يسهل نسيانه؟",
    "أكثر لحظة ضعف ما تحب أحد يعرفها عنك؟",
    "ما هو الشيء اللي لو عرفه عنك أقرب الناس لك — كان يغيّر نظرته فيك؟",
    "هل سبق تعلّقت بشخص بدرجة أخافتك؟",
    "أكثر شيء تكذب على نفسك فيه يومياً؟",
    "هل سبق أحسست إنك تعبت من كونك 'الشخص القوي' دايماً؟",
    "من هو الشخص اللي مهما تغضب منه ما تقدر تنساه؟",
    "هل أنت من النوع اللي يحتاج يسمع 'أنا موجود' ولا يكتفي بوجود الناس الفعلي؟",
    "شيء تمنيت لو أحد يلاحظه فيك بدون ما تطلب؟",
    "آخر مرة كنت فعلاً سعيد — إيش كانت الظروف؟",
    "هل تعتقد إن الناس تتعامل معك بالطريقة اللي تستاهلها؟",
    "أكثر شخص خذلك في وقت كنت محتاجه؟",
    "هل سبق أحسست إنك غريب حتى عن نفسك؟",
    "ما هو الشيء اللي تتمنى تسمعه من شخص معين ولا يقوله؟",
    "هل أنت راضٍ عن الشخص اللي صرت فيه — ولا الطريق لا زالت طويلة؟",
    "لو تكتب جملة واحدة الآن لنفسك — إيش تكتب؟",
]

LOW_KHAYROOK_QUESTIONS = [
    "لو خيروك — تاكل أكلك المفضل كل يوم بس تفقد طعمه بعد أسبوع، أو ما تاكله مرة ثانية وتفضل تتذكر طعمه؟",
    "لو خيروك — كل أكلك يطلع حار جداً للأبد حتى الحلويات، أو كل شيء تشربه يطلع مالح حتى الماء؟",
    "لو خيروك — تاكل وجبة واحدة في اليوم بس تختارها وتاكلها بشهية كاملة، أو تاكل كل شيء تبيه بس بدون ما تحس بأي نكهة؟",
    "لو خيروك — ما تشرب قهوة ولا شاي للأبد، أو ما تاكل أي حلويات للأبد؟",
    "لو خيروك — تحضر أكلك بنفسك كل يوم ساعتين، أو تاكل توصيل كل يوم بس دايماً يجي ناقص صنف؟",
    "لو خيروك — ما تاكل لحم للأبد، أو ما تاكل أرز للأبد؟",
    "لو خيروك — تاكل في أفضل مطعم بالعالم لحالك، أو تاكل أكل بيت عادي مع ناس تحبهم؟",
    "لو خيروك — تحس بالجوع الشديد كل ساعتين بس الأكل موجود، أو ما تحس بجوع خالص بس ما تقدر تستمتع بالأكل؟",
    "لو خيروك — طعم كل شيء حلو يتحول لمر، أو كل شيء مالح يتحول لحامض؟",
    "لو خيروك — تاكل بدون ما تشبع للأبد، أو تشبع من أول لقمة للأبد؟",
    "لو خيروك — تنام ٤ ساعات وتصحى نشيط تماماً، أو تنام ١٢ ساعة وتصحى منهك كل يوم؟",
    "لو خيروك — ما تقدر تنام إلا بين الناس، أو ما تقدر تنام إلا وأنت لحالك تماماً؟",
    "لو خيروك — كل أحلامك تكون عن ناس رحلوا من حياتك، أو ما تحلم خالص للأبد؟",
    "لو خيروك — تصحى كل يوم وأنت ناسي نص نهارك السابق، أو تصحى وتتذكر كل شيء بتفاصيله الكاملة؟",
    "لو خيروك — تنام ٨ ساعات بس في أوقات غريبة ما تختارها، أو تنام وقتك المفضل بس ٥ ساعات فقط؟",
    "لو خيروك — يصحّيك شخص تكره كل يوم بطريقة لطيفة، أو تصحى بمنبه صاخب بس لحالك؟",
    "لو خيروك — كل ما تنام تصحى في مكان مختلف، أو تنام دايماً في نفس المكان الواحد طول حياتك؟",
    "لو خيروك — ما تحس براحة بعد أي قيلولة للأبد، أو ما تقدر تنام في الليل إلا ساعتين متقطعتين؟",
    "لو خيروك — تحذف واتساب للأبد، أو تحذف إنستغرام وسناب معاً للأبد؟",
    "لو خيروك — كل رسائلك الخاصة تُقرأ من شخص واحد تختاره، أو كل صورك الخاصة تُشارك مع شخص واحد ما تختاره؟",
    "لو خيروك — ما تقدر ترسل رسايل صوتية للأبد، أو ما تقدر ترد على أي رسالة خلال أول ساعة؟",
    "لو خيروك — بطارية جوالك تخلص كل ساعتين وما عندك شاحن إلا في البيت، أو جوالك يشتغل بس بدون أي إشعارات للأبد؟",
    "لو خيروك — كل اللي تكتبه في نوتاتك الخاصة يظهر لأقرب شخص لك، أو كل محادثاتك تُحفظ وتُراجع بعد سنة؟",
    "لو خيروك — تعيش بدون إنترنت سنة كاملة، أو تعيش بإنترنت بس ما تقدر تكلم أي أحد تعرفه؟",
    "لو خيروك — أي شخص يقدر يعرف مكانك في أي وقت، أو أي شخص يقدر يسمع محادثاتك الصوتية؟",
    "لو خيروك — تفقد كل صورك وذكرياتك الرقمية من الأول، أو تفقد كل أرقام الناس وما تقدر تتواصل معهم إلا لو هم بادروا؟",
    "لو خيروك — مليون الحين وما تشتغل مرة ثانية، أو عشرة ملايين بعد عشر سنين من شغل تكرهه؟",
    "لو خيروك — راتب عالي جداً في وظيفة تحس فيها إنك تضيع وقتك، أو راتب يكفيك بالضبط في شغل يعطيك معنى؟",
    "لو خيروك — تنفق كل مدخراتك على تجربة واحدة ما تنسى، أو تحتفظ بها وتعيش بأمان لكن بدون أي مغامرة؟",
    "لو خيروك — تعيش في بيت ممتاز في مدينة ما تحبها، أو شقة بسيطة في المكان اللي تحبه؟",
    "لو خيروك — تعطي نص مدخراتك لشخص يحتاجها وما تعرفه، أو تحتفظ بها لكن تعيش بدون أي رفاهية سنة كاملة؟",
    "لو خيروك — سيارة أحلامك بس ما تقدر تسافر بالطيارة للأبد، أو تسافر متى تبي بس تمشي على رجليك في كل مكان؟",
    "لو خيروك — تشتغل من البيت بس تحس بالعزلة، أو تروح مكتب كل يوم بس تكون مع ناس ما تحبهم؟",
    "لو خيروك — تنجح مالياً وكل الناس تعتقد إن الحظ وصلك، أو تفشل وكل الناس تعرف إنك بذلت كل شيء؟",
    "لو خيروك — صديق واحد يعرفك أكثر من نفسك، أو عشرة أصدقاء ما يعرفونك خالص؟",
    "لو خيروك — تعرف كل شيء يتقال عنك في ظهرك من الكل، أو ما تعرف شيء للأبد حتى من أقرب الناس؟",
    "لو خيروك — تخسر أعز صديق عندك، أو تبقى معه بس تعرف إنه خذلك مرة وما اعترف؟",
    "لو خيروك — كل الناس تحبك بس ما أحد يحترمك، أو كل الناس تحترمك بس ما أحد يحبك؟",
    "لو خيروك — تقطع علاقة شخص تحبه لأنه يأثر عليك سلباً، أو تبقى معه وتعرف إنه يسحبك لأسفل؟",
    "لو خيروك — تعرف مين من الناس يحبك فعلاً بس تخسر عنصر المفاجأة، أو تعيش بدون ما تعرف وتصدم دايماً؟",
    "لو خيروك — تكون الشخص اللي يُنسى بعد ما يرحل، أو الشخص اللي يُتذكر بألم؟",
    "لو خيروك — تحب بجنون شخص ما يبادلك، أو تُحب بجنون من شخص ما تحبه؟",
    "لو خيروك — تتعب جسدياً بشدة بس ما تمرض يوم واحد، أو صحتك ممتازة بس تحس بإرهاق دايم بدون سبب؟",
    "لو خيروك — تفقد حاسة الشم للأبد، أو تفقد حاسة اللمس في يديك فقط؟",
    "لو خيروك — وزنك يتغير ١٠ كيلو كل شهر بشكل غير متوقع، أو تبقى بنفس الوزن للأبد حتى لو تعبت رياضة؟",
    "لو خيروك — تنام وتصحى وشعرك اتغير شكله كلياً، أو صوتك اتغير خالص لصوت ما تعرفه؟",
    "لو خيروك — تحس بألم خفيف مستمر كل يوم، أو ألم شديد مرة في الشهر ويروح؟",
    "لو خيروك — عيونك تتعب من الشاشات بعد ١٠ دقائق، أو رجليك تتعب من أي مشي بعد ١٥ دقيقة؟",
    "لو خيروك — تعيش صحيح وتروح بسرعة، أو تعيش طويل بصحة متوسطة؟",
    "لو خيروك — ضحكتك تطلع بكاء دايماً قدام الناس، أو بكاءك يطلع ضحكة دايماً؟",
    "لو خيروك — ترجع لعمر ١٦ وتعيد كل شيء بس بدون أي ذكريات من الحين، أو تبقى بعمرك وتعرف إن كل شيء راح يتحسن بعد ١٠ سنين؟",
    "لو خيروك — تعرف يوم وفاتك بالضبط، أو تعيش وأنت تعرف إنك ممكن ترحل في أي لحظة بدون إشارة؟",
    "لو خيروك — تعيش ٦٠ سنة حياة استثنائية ومليانة، أو ١٠٠ سنة حياة آمنة وعادية؟",
    "لو خيروك — ترجع تعيش يوم واحد من ماضيك وتتذكر كل شيء بس ما تغير أي شيء، أو تطلع على يوم واحد من مستقبلك بدون ما تفهم السياق؟",
    "لو خيروك — يمشي وقتك ببطء في كل لحظة حلوة وبسرعة في كل لحظة صعبة، أو العكس تماماً؟",
    "لو خيروك — تنسى كل ذكرياتك المؤلمة وتعيش مرتاح، بس تعرف إنها غيّرتك وما راح تعرف ليش؟",
    "لو خيروك — تعيش اللحظة دايماً بس ما تقدر تخطط لشيء، أو تخطط لكل شيء بدقة بس ما تقدر تستمتع باللحظة؟",
    "لو خيروك — تتوقف جسدياً عند عمر ٢٥ للأبد بس تكمل تعيش وتشوف كل شيء يتغير، أو تكبر بشكل طبيعي؟",
    "لو خيروك — تقرأ أفكار الناس بس ما تقدر توقفها ولا ثانية، أو تتنبأ بالمستقبل بس دايماً متأخر يوم واحد؟",
    "لو خيروك — تعرف كل أسرار الناس اللي حولك، أو الناس تعرف كل أسرارك بس ما أحد يعرف إنه يعرف؟",
    "لو خيروك — تكون غير مرئي بس ما أحد يسمع صوتك، أو يشوفك الكل دايماً بس ما أحد يقدر يتجاهلك؟",
    "لو خيروك — ما أحد يكذب عليك للأبد، أو ما تقدر تكذب أنت على أحد للأبد؟",
    "لو خيروك — تتكلم كل لغات العالم بس ما أحد يفهم لغتك الأصلية، أو تبقى بلغتك بس تحس بكل مشاعر الناس من حولك؟",
    "لو خيروك — تعرف إجابة أي سؤال في العالم بس ما تقدر تشرحه لأحد، أو تشرح أي فكرة ببلاغة بس أحياناً تكون مخطئ؟",
    "لو خيروك — تتحكم في وقت شخص واحد فقط تختاره، أو تتحكم في مكانك أنت فقط في أي وقت؟",
    "لو خيروك — تحكم العالم يوم واحد وتغير شيئاً واحداً للأبد، أو تعيش حياتك العادية بس سعيد بشكل حقيقي دايماً؟",
    "لو خيروك — تتوقف عن الموسيقى للأبد، أو تتوقف عن الأفلام والمسلسلات للأبد؟",
    "لو خيروك — تسافر لكل مكان في العالم بس بدون ما تصور أي لحظة، أو تصور كل شيء بجودة خيالية بس ما تقدر تنشر أي شيء؟",
    "لو خيروك — تسمع نفس الأغنية الواحدة كل يوم للأبد وتحبها، أو ما تسمع أي أغنية تحبها مرة ثانية؟",
    "لو خيروك — كل كتاب تقرأه تنساه بعد أسبوع بس تستمتع بقراءته، أو تحفظ كل شيء تقرأه بس ما تحس بأي متعة؟",
    "لو خيروك — تلعب رياضتك المفضلة مع ناس تكرههم كل أسبوع، أو تتوقف عنها للأبد؟",
    "لو خيروك — رحلة مريحة لمكان ممل، أو رحلة متعبة لمكان أحلامك؟",
    "لو خيروك — تحضر حفلة كبيرة وما تعرف أحد فيها، أو تجلس في بيت مع شخص واحد تحبه طول الليل؟",
    "لو خيروك — هوايتك تتحول لشغلك وتخسر متعتها، أو تبقى هواية وما تكسب منها شيء للأبد؟",
    "لو خيروك — تحقق حلمك الأكبر وأنت لحيدك ما أحد يشاركك الفرحة، أو تتخلى عن الحلم وتبقى محاط بناس تحبهم؟",
    "لو خيروك — تعتذر لشخص ظلمته وهو يرفض سماعك ويتجاهلك، أو ما تعتذر وتعيش مع الذنب هذا للأبد؟",
    "لو خيروك — تعرف الحقيقة الكاملة عن أقرب ناس لك حتى لو كانت مؤلمة، أو تبقى بجهل مريح للأبد؟",
    "لو خيروك — تنجح وكل الناس تظن إن الحظ وصلك، أو تفشل وكل الناس تعرف إنك بذلت كل ما عندك؟",
    "لو خيروك — تخسر شيء تعبت عليه سنين بسبب قرار واحد، أو ما تجرب أصلاً وتضمن ما تخسر؟",
    "لو خيروك — تسامح شخص آذاك بشدة وترجع معه، أو تقطعه وتعيش بدون ما تعرف ليش آذاك؟",
    "لو خيروك — تعرف إن صديقك يكذب عليك وتكمل معه بصمت، أو تواجهه وتخسر الصداقة بالكامل؟",
    "لو خيروك — تعطي شخص فرصة ثانية وتعرف إنه ممكن يكرر نفس الشيء، أو تقطعه وتتساءل طول عمرك لو كان سيتغير؟",
    "لو خيروك — تسكن في مكان تحبه بعيد عن كل أهلك وناسك، أو قريب منهم في مكان ما يناسبك خالص؟",
    "لو خيروك — تغير مدينتك كل سنتين وتبدأ من صفر دايماً، أو تبقى في نفس المكان للأبد وتعرف كل زاوية فيه؟",
    "لو خيروك — بيتك دايماً بارد وما تقدر تدفيه، أو دايماً حار وما تقدر تبرده؟",
    "لو خيروك — جيرانك صاخبين بس يحبونك ويسندونك، أو هادئين تماماً بس باردين وما يعبئون فيك؟",
    "لو خيروك — تسكن في طابق عالٍ بمنظر خيالي بس بدون أسانسير، أو طابق أرضي بدون أي منظر بس بكل راحة؟",
    "لو خيروك — تعيش في مكان تحبه بس المناخ عكس اللي تحبه للأبد، أو مناخك المفضل في مكان ما يناسبك؟",
    "لو خيروك — تكون مشهور في مجالك وكل الناس تعرفك بس ما تحب شغلك، أو مجهول تماماً وشغلك يملأك كل يوم؟",
    "لو خيروك — تنجح في شيء ما تستحقه بسبب حظ، أو تفشل في شيء تستحقه لأن الظروف ما ساعدتك؟",
    "لو خيروك — تشتغل في مشروعك الخاص وتخسر ٣ سنوات من حياتك، أو تبقى موظف بأمان وتتساءل طول عمرك ماذا لو؟",
    "لو خيروك — تنجز كثير وما أحد يلاحظ أو يقدّر، أو تنجز أقل وكل الناس تمجّدك بشكل مبالغ؟",
    "لو خيروك — تتقن مهارة واحدة بشكل أسطوري وما تعرف غيرها، أو تكون متوسط في عشر مهارات؟",
    "لو خيروك — تغير مسارك كلياً الحين وتبدأ من الصفر وعمرك ما يسمح بأخطاء، أو تكمل في مسار ما يرضيك بس آمن؟",
    "لو خيروك — تعرف معنى الحياة بالكامل بس تعيشها وحيداً تماماً، أو ما تعرف أي إجابة وعندك ناس تحبهم؟",
    "لو خيروك — سعادة اصطناعية دايمة بدون سبب حقيقي، أو حياة بمشاعر حقيقية فيها ألم وفرح معاً؟",
    "لو خيروك — تغير العالم بشكل جوهري وما أحد يعرف إنك السبب للأبد، أو تغير شخص واحد وكل الناس تشوف أثرك؟",
    "لو خيروك — تعيش يومك المثالي تماماً بس تتذكر بعده إنه لن يتكرر، أو تعيش حياتك العادية وأنت تأمل دايماً؟",
    "لو خيروك — تنسى كل ألمك وتعيش خفيفاً لكن تفقد كل الحكمة اللي بناها الألم فيك، أو تحتفظ بكل جروحك وكل ما تعلمته منها؟",
    "لو خيروك — حياة قصيرة مليانة بلحظات ما تُنسى وناس تحبهم، أو حياة طويلة هادئة وآمنة لحالك؟",
]

TRUTH_OR_DARE_QUESTIONS = [
    "صراحة: وسم آخر شخص بعثتيه/بعثتيلو رسالة بالليل ومالكش تحكي فيه قدام الناس",
    "صراحة: قول لينا اكبر كدبة كدبتيها على والديك",
    "صراحة: شكون فالقروب هذا لي ما تحبش تشوف وجهو خالص؟",
    "صراحة: اخر مرة بكيت فيها — علاش وقدام شكون؟",
    "صراحة: وسم الشخص لي ضايق عليك وعلى الفون ديالك",
    "صراحة: شكون فيكم كان يكدب على أستاذ وهو صغير — قول واحدة منها",
    "صراحة: قول لينا شنو أكبر سر تخبي على صحابك",
    "صراحة: وسم اللي عندك نية تعتذر ليه وما عندكش الجرأة",
    "صراحة: اخر مرة تشاجرت مع حد — شكون كان وعلاش؟",
    "صراحة: شنو أغبى حاجة دارتيها بسبب شخص؟",
    "صراحة: وسم صاحب/صاحبة كنت قريب منو وهجرتو بلا سبب واضح",
    "صراحة: شكون فالقروب هذا لو ما كانوش صحابك ماكنتش تكلمو أبداً؟",
    "صراحة: قول لينا اسم الشخص لي خسرتيه وزلت تتندم عليه",
    "صراحة: شنو أصعب حاجة قلتيها لصاحب/صاحبة؟",
    "صراحة: وسم اللي تعرف أنو يعيّط عليك وراك وتديرو ماشي",
    "صراحة: شكون فيكم عندو صاحب سري ما يعرفوش الآخرين؟ وسمو",
    "صراحة: قول لنا رأيك الحقيقي في صاحبك لي جنبك دروك",
    "صراحة: شنو الحاجة لي ما تسامحش عليها فالصداقة؟",
    "صراحة: وسم اللي كلامو يزعجك ولا تقول ليه والو",
    "صراحة: اخر مرة خان فيك صاحب — شنو دار؟",
    "صراحة: وسم اللي عجبك لأول مرة شفتو وقلبك عمل شي",
    "صراحة: شنو أصعب شي قلتيه لشخص تحبو؟",
    "صراحة: قول لينا اكبر حاجة ندمت عليها في علاقة فاتت",
    "صراحة: وسم اللي زلت تفكر فيه وما تعترف بيه",
    "صراحة: شنو الصفة لي لازم تكون في شريك/شريكة حياتك — الحقيقية مش الرسمية؟",
    "صراحة: اخر مرة قلبك تألم — علاش؟",
    "صراحة: وسم اللي لو جاك/جاتك يطلب الصفح كنت تسامحو",
    "صراحة: شنو أكبر غلطة دارتيها في حق شخص كان يحبك؟",
    "صراحة: قول لنا هل عندك حاليا شخص يدور في بالك ما يعرفش",
    "صراحة: شنو الحاجة لي تتمنى يعرفها شخص معين فيك؟",
    "صراحة: اكبر كدبة كدبتيها على أمك وما عرفت بيها",
    "صراحة: شنو الحاجة لي تخبيها على والديك وتموت ما تعرفوها؟",
    "صراحة: قول لينا أكثر حاجة تزعجك في البيت وما تقدر تقولها",
    "صراحة: شكون في عيلتك لي تتمنى تقولو كلام ما تجراش عليه؟",
    "صراحة: اخر مرة كنت فضيح قدام عيلتك — شنو وقع؟",
    "صراحة: قول لينا كم مرة غشيت في امتحان وكيفاش؟",
    "صراحة: شنو أسوأ درجة جبتيها وشنو قلت للدار؟",
    "صراحة: وسم اللي كنت تغشش منو بلا ما يعرف",
    "صراحة: قول لنا أغرب عذر اختلقتيه باش ما تمشيش للمدرسة",
    "صراحة: شنو الحاجة لي تتمنى تقولها لأستاذ ما تجراش عليه؟",
    "صراحة: شنو العيب لي تعرف أنو فيك وما تحب الناس تشوفو؟",
    "صراحة: قول لنا الحاجة لي تغير فيك لو قدرت بجدعة",
    "صراحة: شنو الشي لي تحسد عليه أكثر واحد فالقروب هذا؟",
    "صراحة: اخر مرة حسيت بالغيرة — من شكون وعلاش؟",
    "صراحة: شنو أكبر خوفك لي ما يعرفوش الناس؟",
    "صراحة: قول لنا حاجة تفعلها وحدك وتخجل منها قدام الناس",
    "صراحة: شنو أكبر حسرة عندك لحد دروك؟",
    "صراحة: لو عندك يوم تعيش فيه بلا ما يشوفك حد — شنو كنت تدير؟",
    "صراحة: شنو الحاجة لي قالوها فيك وجرحتك وزلت فبالك؟",
    "صراحة: قول لنا شي تشوفو فالمرآية وما يعجبكش",
    "جرأة: اشرب لتر ماء في أقل من دقيقة",
    "جرأة: قلد أستاذ أو أستاذة معروفة لمدة دقيقتين",
    "جرأة: ارسم وجهك بعينين مغمضين وشارك الصورة في القروب",
    "جرأة: قول لأمك أو أبوك 'واش بغيتوني؟' وخلي الجو يتوتر",
    "جرأة: اكتب رسالة عشوائية لآخر شخص في جهات اتصالك",
    "جرأة: قلد صوت حيوان لمدة 30 ثانية بدون ما تضحك",
    "جرأة: ارقص 20 ثانية بدون موسيقى",
    "جرأة: اتصل بشخص عشوائي من جهاتك وقلو 'واش وصل الطرد؟'",
    "جرأة: اكتب 'أنا نحب فلان' في الستوري — الاسم يختارو القروب",
    "جرأة: قلد شخص في القروب بدون ما تقول اسمو، والكل يخمن من هو",
    "جرأة: ابعث رسالة 'نفتقدك' لأول شخص في جهات اتصالك",
    "جرأة: اتصل بصاحب ما كلمتوش من زمان وعمل إنو غلطة",
    "جرأة: اكتب بوست على واتساب ستاتوس بيها نص يختارو ليك القروب",
    "جرأة: غير صورة البروفيل ديالك لصورة يختارها القروب لمدة ساعة",
    "جرأة: ابعث صورة سيلفي بأغرب شكل لأقرب شخص عندك",
    "جرأة: اتصل بشخص وقلو 'عندي شي نقولك إياه مهم' وبعدين قلو 'ما شي وقتو' وقطع",
    "جرأة: غير اسمك في القروب لاسم يختارو ليك الآخرين لمدة ساعتين",
    "جرأة: ابعث رسالة 'كنت نفكر فيك' لشخص تختارو سبحة",
    "جرأة: اطلب من شخص في القروب يصف فيك بكلمة واحدة صادقة",
    "جرأة: اكتب شي تخبيه عادةً وشاركو مع القروب",
    "جرأة: اعمل 20 سقطة الآن وشارك الفيديو",
    "جرأة: قف على رجل واحدة لمدة دقيقة كاملة",
    "جرأة: كل شي ما كلتوش من زمان موجود في البيت دروك",
    "جرأة: اقرأ آخر رسالة في محادثة خاصة بصوت عالي",
    "جرأة: اكتب بيدك غير المهيمنة جملة وشارك الصورة",
    "جرأة: خذ دوش بالماء البارد وارجع تقول لنا كيفاش كانت التجربة",
    "جرأة: روح جيب شي من بره البيت بلا ما تحكي مع حتى واحد",
    "جرأة: اشرب كأس ماء بدون استخدام يديك",
    "جرأة: قل 10 كلمات من لغة ما تعرفهاش",
    "جرأة: اعمل تحدي الثلج — حط يدك في ماء بارد 30 ثانية",
    "جرأة: روح قول لباباك أو أمك 'عندي خبر مهم' وبعدين قلو 'ما كان والو، تبركاليك'",
    "جرأة: اطرق باب الجار وقلو 'واش شفتوا قطة؟' وارجع",
    "جرأة: ابعث لعمك أو خالك رسالة 'منزيدش نقرى' وشوف ردة الفعل",
    "جرأة: نادي على أمك بصوت عالي ولما تجي قلها 'ما شي والو، نحبك'",
    "جرأة: اطلب من الشخص الأكبر في البيت يعلمك أغنية قديمة",
    "جرأة: شارك آخر صورة في رول الكاميرا ديالك في القروب بلا ما تشوفها",
    "جرأة: اقرأ آخر رسالة بعثيتها على واتساب بصوت عالي",
    "جرأة: شارك آخر يوتيوب أو تيكتوك شفتو في القروب",
    "جرأة: غير اسمك في القروب لآخر ايموجي استخدمتيه",
    "جرأة: ابعث رسالة صوتية لمدة دقيقة كاملة ما تقول فيها والو غير أصوات",
    "جرأة: اعتذر بصوت عالي قدام الكل لشخص في القروب أزعجتيه قبل",
    "جرأة: قول مدح لكل شخص في القروب — جملة واحدة صادقة لكل واحد",
    "جرأة: حكي قصة محرجة حدثت ليك والكل يصوت عليها بـ 'صح' أو 'كدب'",
    "جرأة: اتصل بشخص ما كلمتوش من سنة وعمل إنك غلطت في الرقم",
    "جرأة: غن مقطع من أغنية تحبها بصوت عالي وسجل وشاركو",
    "جرأة: قول الحاجة لي تتمنى تقولها لشخص معين بدون ما تذكر اسمو",
    "جرأة: اكتب رسالة صادقة 100% لشخص في القروب وابعثيهالو مباشرة",
    "جرأة: قول 3 أشياء ما يعرفهاش الناس عنك",
    "جرأة: اطلب من القروب يقيمك من 1 لـ10 في الصدق — وتقبل النتيجة بدون ما تتبرر",
    "جرأة: قول لنا الشخص لي في القروب هذا لو تقدر تبعثلو رسالة مجهولة شنو كنت تقولو — وقولها دروك بصوت عالي",
]

# تتبع الأسئلة المستخدمة لكل محادثة {chat_id: set of used indices}
_kat_used: dict        = {}
_lowk_used: dict       = {}
_tod_used: dict        = {}


def _get_random_question(questions: list, used_dict: dict, chat_id: int) -> str:
    """يرجع سؤال عشوائي غير مكرر، وإذا اكتملت الأسئلة يبدأ من جديد."""
    used = used_dict.setdefault(chat_id, set())
    remaining = [i for i in range(len(questions)) if i not in used]
    if not remaining:
        used_dict[chat_id] = set()
        remaining = list(range(len(questions)))
    idx = random.choice(remaining)
    used_dict[chat_id].add(idx)
...
ALL_ACHIEVEMENTS = [
    {"id":"first_game",  "name":"🎮 أول لعبة",      "desc":"العب أول لعبة",               "reward_coins":200},
    {"id":"10_correct",  "name":"✅ عشرة صحيحة",     "desc":"أجب على 10 أسئلة صحيحة",      "reward_coins":300},
    {"id":"streak_5",    "name":"🔥 سلسلة ناجحة",    "desc":"سلسلة 5 إجابات صحيحة",        "reward_coins":500},
    {"id":"streak_10",   "name":"⚡ سلسلة أسطورية",  "desc":"سلسلة 10 إجابات",             "reward_coins":1000},
    {"id":"100_points",  "name":"⭐ مئة نقطة",       "desc":"اجمع 100 نقطة",               "reward_coins":150},
    {"id":"500_points",  "name":"🌟 خمسمئة نقطة",    "desc":"اجمع 500 نقطة",               "reward_coins":400},
    {"id":"1000_points", "name":"💎 ألف نقطة",       "desc":"اجمع 1000 نقطة",              "reward_coins":800},
    {"id":"first_win",   "name":"🏆 أول انتصار",     "desc":"افوز بأول تحدٍّ",             "reward_coins":600},
    {"id":"first_harvest","name":"🌾 أول حصاد",      "desc":"احصد محصولك الأول",            "reward_coins":500},
    {"id":"farm_lvl3",   "name":"🌳 مزرعة متقدمة",   "desc":"ارقِّ مزرعتك للمستوى 3",      "reward_coins":1000},
    {"id":"rich_farmer", "name":"💰 مزارع ثري",      "desc":"اجمع 5000 في مزرعتك",         "reward_coins":1500},
    {"id":"bank_1000",   "name":"🏦 مدخّر",          "desc":"اجمع 1000 في البنك",           "reward_coins":300},
    {"id":"transfer_1",  "name":"💸 أول تحويل",      "desc":"أجرِ أول تحويل بنكي",         "reward_coins":200},
]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton(" ألعاب أخرى ", callback_data="choose_cut_game"),
        ],
        [
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ━━ ألعاب أخرى ━━
    if data == "choose_cut_game":
        keyboard = [
            [InlineKeyboardButton("🎭 لعبة كت",              callback_data="cut_game")],
            [InlineKeyboardButton("🤔 لعبة لو خيروك",        callback_data="choose_game")],
            [InlineKeyboardButton("🔥 لعبة جرأة أو صراحة",   callback_data="Truth or dare_game")],
        ]
    ...
    if data == "cut_game":
        q = _get_random_question(KAT_QUESTIONS, _kat_used, update.effective_chat.id)
        await query.message.reply_text(f"🎭 كت\n\n{q}")
        return

    if data == "choose_game":
        q = _get_random_question(LOW_KHAYROOK_QUESTIONS, _lowk_used, update.effective_chat.id)
        await query.message.reply_text(f"🤔 لو خيروك\n\n{q}")
        return

    if data == "Truth or dare_game":
        q = _get_random_question(TRUTH_OR_DARE_QUESTIONS, _tod_used, update.effective_chat.id)
        await query.message.reply_text(f"🔥 جرأة أو صراحة\n\n{q}")
        return
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_group:
        ...
        if "ويليم" in text_lower:
            ...
            await update.message.reply_text(
                f"حل عني مش فاضيلك يا {user.first_name} ! \n"
            )
            return
        # إذا لم يكن مفعّلاً في هذه المجموعة، لا يرد
        if not group_active.get(chat.id):
            await update.message.reply_text(
                f"البوت غير مفعل في هذه المجموعة يرجى رعه إلى مشرف في هذه المجموعة لكي يعمل\n"
            )
            return
    ...
    # ━━ ألعاب كت / لو خيروك / جرأة أو صراحة ━━
    if text in ["كت", "لعبة كت"]:
        q = _get_random_question(KAT_QUESTIONS, _kat_used, update.effective_chat.id)
        await update.message.reply_text(f"{q} \n")
        return

    if text in ["لو خيروك", "لعبة لو خيروك"]:
        q = _get_random_question(LOW_KHAYROOK_QUESTIONS, _lowk_used, update.effective_chat.id)
        await update.message.reply_text(f"{q} \n")
        return

    if text in ["جرأة أو صراحة", "جراة او صراحة", "جرأة او صراحة", "لعبة جرأة أو صراحة"]:
        q = _get_random_question(TRUTH_OR_DARE_QUESTIONS, _tod_used, update.effective_chat.id)
        await update.message.reply_text(f"{q} \n")
        return
